...
export default function BarberProfileScreen({ navigation }) {
        ...
        try {
            ...
            if (barber) {
                ...
                setInitialData({
                    ...
                    homeOpen: barber.availability?.home?.openTime || '09:00',
                    homeClose: barber.availability?.home?.closeTime || '19:00',
    ...
    const handleSave = async () => {
        ...
        // Validate hours
        if (showSalon && salonOpen >= salonClose) { Alert.alert('Error', 'Salon close time must be after open time'); return; }
        if (showHome && homeOpen >= homeClose) { Alert.alert('Error', 'Home service close time must be after open time'); return; }
        ...
        try {
            ...
            // Refresh local state and go back
            loadProfile();
            navigation.goBack();
        } catch (e) {
        ...
        <SafeAreaView style={[styles.container, { backgroundColor: theme.background }]}>
            ...
            <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
                ...
                <Card theme={theme}>
                    ...
                    <FieldLabel theme={theme}>Bio / Description</FieldLabel>
                    <FieldInput
                        theme={theme}
                        value={bio}
                        onChangeText={setBio}
                        placeholder="Tell customers about your skills and style..."
                        multiline
                        numberOfLines={3}
